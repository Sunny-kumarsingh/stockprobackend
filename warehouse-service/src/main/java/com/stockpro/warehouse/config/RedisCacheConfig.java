...
public class RedisCacheConfig implements CachingConfigurer {
    ...
    public CacheManager cacheManager(RedisConnectionFactory connectionFactory) {
        ...
        Map<String, RedisCacheConfiguration> cacheTtls = Map.of(
                "warehouses", defaultConfig.entryTtl(Duration.ofMinutes(10)),
                "warehouse", defaultConfig.entryTtl(Duration.ofMinutes(10)),
                "warehouseInventory", defaultConfig.entryTtl(Duration.ofMinutes(2)),
                "warehouseStock", defaultConfig.entryTtl(Duration.ofMinutes(2)),
                "lowStockReport", defaultConfig.entryTtl(Duration.ofMinutes(2))
        );
